                    ...
                    <div class="form-row">
                        ...
                        <div class="col-lg-12 div_renewal">
                            ...
                            <div class="form-group">
                                <label class="text-md-right text-left">Fixed Interest Amount</label>
                                <label class="custom-switch mt-2">
                                    <span class="custom-switch-description"> No &nbsp;</span>
                                    <input type="checkbox" onchange="fixedInterest()" value="1" class="input-item custom-switch-input"name="input[fixed_interest]" id="fixed_interest">
