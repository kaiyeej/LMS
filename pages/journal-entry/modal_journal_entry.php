                                ...
                                <form method='POST' id='frm_submit_2'>
                                    ...
                                    <div class="form-group row">
                                        <div class="col">
                                            ...
                                            <div>
                                                <input type="number" step="0.01" min="0" class="form-control" class="form-control input-item" name="input[debit]" id="debit">
                                            </div>
                                        </div>
                                        <div class="col">
                                            <label><strong>Credit</strong></label>
                                            <div>
                                            <input type="number" step="0.01" min="0" class="form-control" class="form-control input-item" name="input[credit]" id="credit">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
