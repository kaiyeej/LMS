            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="col-lg-7">
                            <div class="row">
                                <input type="hidden" class="form-control" autocomplete="off" id="renewal_status_renewal" name="input[renewal_status]" readonly>
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <button type="button" style="float: right;" class="btn btn-icon icon-right btn-warning" onclick="sampleCalculation2()">Sample Calculation</button>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.input-renewal').map(function() {
                    ...
                    console.log(id_name + " :: " + json[id_name].slice(0, -8));
