            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-row">
                        <div class="col-lg-7">
                            <div class="row">
                                <input type="hidden" class="form-control" autocomplete="off" id="renewal_status_renewal"
                                    name="input[renewal_status]" readonly>
                                <div class="form-group col-md-12">
                                    <label style="color: #6777ef;font-weight: bold;">Ref. #: </label>
                                    <input type="text" autocomplete="off" name="input[reference_number]"
                                        id="reference_number_renewal" class="reference_number"
                                        style="background: transparent;border: none;outline: none;color: #6777ef;font-size: 18px;font-weight: bold;"
                                        readonly required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Branch</label>
                                    <select class="form-control select2 branch_id" id="branch_id_renewal"
                                        name="input[branch_id]" style="width:100%;" onchange="getClients2()" required>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Client</label>
                                    <select class="form-control select2 client_id" id="client_id_renewal"
                                        name="input[client_id]" onchange="getLoans()" style="width:100%;" required>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Loan</label>
                                    <select class="form-control select2 loan_id" onchange="loan_renewal()"
                                        id="loan_id_renewal" name="input[loan_id]" style="width:100%;" required>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Loan Type</label>
                                    <input type="text" class="form-control input-renewal" autocomplete="off"
                                        id="loan_type_renewal" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Loan Date</label>
                                    <input type="date" class="form-control" autocomplete="off" name="input[loan_date]"
                                        id="loan_date_renewal" onchange="getBalance()" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label><strong style="color:red;">*</strong> Loan amount</label>
                                    <input type="number" step="0.01" class="form-control input-renewal"
                                        onchange="calculateInterest2()" autocomplete="off" name="input[loan_amount]"
                                        id="loan_amount_renewal" required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong> Loan Interest</label>
                                    <input type="number" step="0.01" class="form-control input-al input-renewal"
                                        autocomplete="off" name="input[loan_interest]" id="loan_interest_renewal"
                                        required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong>Penalty %</label>
                                    <input type="number" step="0.01" class="form-control input-al input-renewal"
                                        autocomplete="off" name="input[penalty_percentage]"
                                        id="penalty_percentage_renewal" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong> Payment Terms <sub
                                            style="color:red;">(months)</sub></label>
                                    <input type="number" step="0.01" class="form-control input-al input-renewal"
                                        autocomplete="off" name="input[payment_terms]" id="payment_terms_renewal"
                                        required>
                                </div>

                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong> Loan Terms</label>
                                    <input type="number" class="form-control input-al input-renewal" autocomplete="off"
                                        name="input[loan_period]" id="loan_period_renewal" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong> Service Fee</label>
                                    <input type="number" step="0.01" class="form-control input-renewal"
                                        autocomplete="off" name="input[service_fee]" id="service_fee_renewal" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label><strong style="color:red;">*</strong> Monthly Payment</label>
                                    <input type="number" class="form-control input-renewal" autocomplete="off"
                                        name="input[monthly_payment]" id="monthly_payment_renewal" step="0.01" required>
                                </div>
                                <div class="form-group col-md-12">
                                ...
                                <div class="col-lg-12 div_renewal">
                                    ...
                                    <div class="form-group">
                                        <label class="custom-switch mt-2">
                                            ...
                                            <input type="checkbox" onchange="deductToLoan()" value="1"
                                                id="deduct_to_loan" name="input[deduct_to_loan]"
                                                class="input-renewal custom-switch-input">
                                ...
                                <div class="div_collection form-group col-md-4">
                                    <label>Bank</label>
                                    <select class="form-control select2 input-renewal chart_id" id="chart_id_renewal"
                                        name="input[chart_id]" style="width:100%;" required>
                                    </select>
                                </div>
                                <div class="div_collection form-group col-md-4">
                                    <label>Penalty</label>
                                    <input type="number" step="0.01" class="form-control penalty_amount"
                                        autocomplete="off" name="input[penalty_amount]" id="penalty_amount_renewal"
                                        required>
                                </div>
                                <div class="div_collection form-group col-md-4">
                                    <label>Amount</label>
                                    <input type="number" step="0.01" class="form-control amount"
                                        placeholder="Collection amount" autocomplete="off" name="input[amount]"
                                        id="amount_renewal" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5" style="padding: 10px;border: 1px dashed #ff9800;border-radius: 5px;">
                            <div class="table-responsive">
                                <button type="button" style="float: right;"
                                    class="btn btn-icon btn-sm icon-right btn-warning"
                                    onclick="sampleCalculation2()">Sample Calculation</button>
                                <div class="table-responsive"
                                    style="padding-top: 5px;max-height: 80vh;overflow-y: auto;">
                                    <table id="dt_calculation2" class="table table-striped"
