                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <div class="btn-group">
                                ...
                                <div class="btn-group btn-group" role="group" aria-label="Basic example">
                                    <a href="#" data-toggle="dropdown" class="btn btn-success dropdown-toggle"><i class="fas fa-coins"></i> Mass Collection</a>
                                    <div class="dropdown-menu">
                                        <a href="#" class="dropdown-item has-icon" onclick="addMassCollection()"><i class="fas fa-plus"></i> Add</a>
                                        <a href="#" class="dropdown-item has-icon" onclick="viewSavedMassCollection()"><i class="far fa-list"></i> View
                                            Saved</a>
                                    </div>
                                </div>
                                <div class="btn-group btn-group" role="group" aria-label="Basic example">
