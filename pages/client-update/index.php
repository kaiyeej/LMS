                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="col-md-12">
                                ...
                                <a href="#" style="float: right;" onclick="getPreview()" class="btn btn-lg btn-icon icon-left btn-warning"><i class="fa fa-print"></i>
                                    Print</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="property-tab3" data-toggle="tab" href="#property" role="tab" aria-controls="property" aria-selected="false"><i class="fas fa-home"></i>
                                        Property</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="family-tab3" data-toggle="tab" href="#family" role="tab" aria-controls="family" aria-selected="false"><i class="fas fa-users"></i>
                                        Family</a>
                                </li>
                            </ul>
                                        ...
                                        <form method='POST' id='frm_client_1'>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong> First name
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Civil
                                                                Status</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-8">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[residence]" id="residence" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item" id="residence_status" name="input[residence_status]" required>
                                                            <option value="">Please Select</option>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Certificate
                                                                #</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[residence_certificate_no]" id="residence_certificate_no" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[certificate_issued_at]" id="certificate_issued_at" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control input-item" autocomplete="off" name="input[certificate_date]" id="certificate_date" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="select2 form-control input-item" id="employer_id" name="input[employer_id]" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[employer_address]" id="employer_address" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[employer_contact_no]" id="employer_contact_no" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[employment_position]" id="employment_position" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[employment_income]" id="employment_income" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[employment_status]" id="employment_status" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[employment_length]" id="employment_length" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[last_employment]" id="last_employment">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_name]" id="spouse_name">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_residence]" id="spouse_residence">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_res_cert_no]" id="spouse_res_cert_no">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_res_cert_issued_at]" id="spouse_res_cert_issued_at">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control input-item" autocomplete="off" name="input[spouse_res_cert_date]" id="spouse_res_cert_date">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employer]" id="spouse_employer">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employer_address]" id="spouse_employer_address">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employer_contact]" id="spouse_employer_contact">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employment_position]" id="spouse_employment_position">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employment_income]" id="spouse_employment_income">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employment_length]" id="spouse_employment_length">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_last_employment]" id="spouse_last_employment">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[spouse_employment_status]" id="spouse_employment_status">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[no_of_children]" id="no_of_children">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[dep_no_of_child]" id="dep_no_of_child">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[dep_college]" id="dep_college">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[dep_hs]" id="dep_hs">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[dep_elem]" id="dep_elem">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-12">
                                        ...
                                        <div id="page_content_3" class="tab wizard-pane">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Source Of
                                                                Income</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[soi_name]" id="soi_name" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Source of income
                                                                by whom</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="" name="input[soi_by]" id="soi_by" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Monthly
                                                                Income</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" placeholder="" name="input[soi_monthly]" id="soi_monthly" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Aprox Total
                                                                Income</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[soi_total]" id="soi_total" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Total Oustanding
                                                                Obligation</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[soi_obligation]" id="soi_obligation" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Account
                                                                No.</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Reference Name
                                                                1</span>
                                                        </div>
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Reference Address
                                                                1</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Business
                                                                Name</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Business name" name="input[business_name]" id="business_name" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_address]" id="business_address" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Telephone
                                                                No.</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_contact]" id="business_contact" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_position]" id="business_position" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_kind]" id="business_kind" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[business_length]" id="business_length" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Capital
                                                                Invested</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[business_capital]" id="business_capital" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item" id="business_type" name="input[business_type]" required>
                                                            <option value="">Please Select</option>
                                        ...
                                        <div id="page_content_3" class="tab wizard-pane">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[insurance_amount]" id="insurance_amount" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[insurance_maturity]" id="insurance_maturity" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Bank
                                                                Transaction</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[insurance_bank_transaction]" id="insurance_bank_transaction" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Unpaid
                                                                Obligation</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[insurance_unpaid_obligation]" id="insurance_unpaid_obligation" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Salary
                                                                Withdrawal</span>
                                                        </div>
                                                        <select class="form-control input-item" id="insurance_salary_withdrawal" name="input[insurance_salary_withdrawal]" required>
                                                            <option value="">Please Select</option>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Paymaster
                                                                Name</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster fullname" name="input[paymaster_name]" id="paymaster_name" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster address" name="input[paymaster_address]" id="paymaster_address" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster certificate number" name="input[paymaster_res_cert_no]" id="paymaster_res_cert_no" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster certificate issued at" name="input[paymaster_res_cert_issued_at]" id="paymaster_res_cert_issued_at" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="input-item form-control input-item" autocomplete="off" placeholder="Paymaster certificate issued date" name="input[paymaster_res_cert_date]" id="paymaster_res_cert_date" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-4" style="padding: 10px;">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            ...
                                                            <input type="checkbox" value="Yes" id="paymaster_deduct_salary" name="input[paymaster_deduct_salary]" class="check-item custom-switch-input">
                                                ...
                                                <div class="col-lg-4" style="padding: 10px;">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            <span class="custom-switch-description"> No &nbsp;</span>
                                                            <input type="checkbox" value="Yes" id="paymaster_client_deduct_salary" name="input[paymaster_client_deduct_salary]" class="check-item custom-switch-input">
                                                            <span class="custom-switch-indicator"></span>
                                                            <span class="custom-switch-description">Yes</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-lg-4" style="padding: 10px;">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            <span class="custom-switch-description"> No &nbsp;</span>
                                                            <input type="checkbox" value="Yes" id="paymaster_conformity" name="input[paymaster_conformity]" class="check-item custom-switch-input">
                                                            <span class="custom-switch-indicator"></span>
                                                            <span class="custom-switch-description">Yes</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-lg-6">
                                                            <div class="input-group">
                                                                <div class="input-group-prepend">
                                                                    <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Market
                                                                        Value</span>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <button type="submit" style="float: right;" class="btn btn-icon icon-right btn-info">Add
                                                                Entry</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <form method='POST' id='frm_children'>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-8">
                                                        <div class="input-group">
                                                            <div class="input-group-prepend">
                                                                <span class="input-group-text"><strong style="color:red;">*&nbsp;</strong>Child
                                                                    Name</span>
                                                            </div>
