                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_soi]" id="client_soi"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            ...
                                                            name="input[client_soi_by_whom]" id="client_soi_by_whom"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01"
                                                            ...
                                                            placeholder="" name="input[client_soi_monthly_income]"
                                                            id="client_soi_monthly_income" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01"
                                                            class="form-control input-item" autocomplete="off"
                                                            name="input[client_approx_total_monthly_income]"
                                                            id="client_approx_total_monthly_income" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01"
                                                            class="form-control input-item" autocomplete="off"
                                                            name="input[client_total_outstanding_obligation]"
                                                            id="client_total_outstanding_obligation" required>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Business
                                                                Name</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" placeholder="Business name"
                                                            name="input[client_business_name]" id="client_business_name"
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_business_address]"
                                                            id="client_business_address" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Telephone
                                                                No.</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_business_tel_no]"
                                                            id="client_business_tel_no" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_business_position]"
                                                            id="client_business_position" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Kind</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_business_kind]"
                                                            id="client_business_kind" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item"
                                                            autocomplete="off" name="input[client_business_length]"
                                                            id="client_business_length" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Capital
                                                                Invested</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01"
                                                            class="form-control input-item" autocomplete="off"
                                                            name="input[client_business_capital_invested]"
                                                            id="client_business_capital_invested" required>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item"
                                                            id="client_business_type" name="input[client_business_type]"
                                                            required>
                                                            <option value="">Please Select</option>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Insurance</span>
                                                        </div>
                                                        <select class="form-control input-item" id="insurance_id"
                                                            name="input[insurance_id]" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Amount</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01"
                                                            class="form-control input-item" autocomplete="off"
                                                            name="input[client_insurance_amount]"
                                                            id="client_insurance_amount" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Maturity</span>
                                                        </div>
                                                        <input type="number" min="0" class="form-control input-item"
                                                            autocomplete="off" name="input[client_insurance_maturity]"
                                                            id="client_insurance_maturity" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Bank
                                                                Transaction</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" name="input[client_bank_transaction]"
                                                            id="client_bank_transaction" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Unpaid
                                                                Obligation</span>
                                                        </div>
                                                        <input type="number" min="0" step="0.01"
                                                            class="form-control input-item" autocomplete="off"
                                                            name="input[client_unpaid_obligation]"
                                                            id="client_unpaid_obligation" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Salary
                                                                Withdrawal</span>
                                                        </div>
                                                        <select class="form-control input-item"
                                                            id="client_salary_withdrawal"
                                                            name="input[client_salary_withdrawal]" required>
                                                            <option value="">Please Select</option>
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Paymaster
                                                                Name</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" placeholder="Paymaster fullname"
                                                            name="input[client_paymaster_name]"
                                                            id="client_paymaster_name" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text"><strong
                                                                    style="color:red;">*&nbsp;</strong>Residence</span>
                                                        </div>
                                                        <input type="text" class="form-control input-item"
                                                            autocomplete="off" placeholder="Paymaster address"
                                                            name="input[client_paymaster_residence]"
                                                            id="client_paymaster_residence" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            ...
                                                            name="input[client_paymaster_res_cert_no]"
                                                            id="client_paymaster_res_cert_no" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item"
                                                            ...
                                                            name="input[client_paymaster_res_cert_issued_at]"
                                                            id="client_paymaster_res_cert_issued_at" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="input-item form-control input-item"
                                                            ...
                                                            name="input[client_paymaster_res_cert_date]"
                                                            id="client_paymaster_res_cert_date" required>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            ...
                                                            <input type="checkbox" value="Yes"
                                                                ...
                                                                name="input[client_paymaster_deduct_salary]"
                                                                class="input-item custom-switch-input">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            ...
                                                            <input type="checkbox" value="Yes"
                                                                ...
                                                                name="input[client_paymaster_client_deduct_salary]"
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-switch mt-2">
                                                            ...
                                                            <input type="checkbox" value="Yes"
                                                                ...
                                                                name="input[client_paymaster_conformity]"
                                                                class="input-item custom-switch-input">
                                                            <span class="custom-switch-indicator"></span>
                                                            <span class="custom-switch-description">Yes</span>
                                                        </label>
