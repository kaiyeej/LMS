                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[client_credit_ref_name2]" id="client_credit_ref_name2">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[client_credit_ref_address2]" id="client_credit_ref_address2">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[client_credit_ref_name3]" id="client_credit_ref_name3">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[client_credit_ref_address3]" id="client_credit_ref_address3">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Business name" name="input[business_name]" id="business_name">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_address]" id="business_address">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_contact]" id="business_contact">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_position]" id="business_position">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[business_kind]" id="business_kind">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[business_length]" id="business_length">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[business_capital]" id="business_capital">
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item" id="business_type" name="input[business_type]">
                                                            <option value="">Please Select</option>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item" id="insurance_id" name="input[insurance_id]">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[insurance_amount]" id="insurance_amount">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control input-item" autocomplete="off" name="input[insurance_maturity]" id="insurance_maturity">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" name="input[insurance_bank_transaction]" id="insurance_bank_transaction">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" min="0" step="0.01" class="form-control input-item" autocomplete="off" name="input[insurance_unpaid_obligation]" id="insurance_unpaid_obligation">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <select class="form-control input-item" id="insurance_salary_withdrawal" name="input[insurance_salary_withdrawal]">
                                                            <option value="">Please Select</option>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster fullname" name="input[paymaster_name]" id="paymaster_name">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster address" name="input[paymaster_address]" id="paymaster_address">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster certificate number" name="input[paymaster_res_cert_no]" id="paymaster_res_cert_no">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control input-item" autocomplete="off" placeholder="Paymaster certificate issued at" name="input[paymaster_res_cert_issued_at]" id="paymaster_res_cert_issued_at">
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="input-item form-control input-item" autocomplete="off" placeholder="Paymaster certificate issued date" name="input[paymaster_res_cert_date]" id="paymaster_res_cert_date">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <button type="submit" style="float: right;" class="btn btn-icon icon-right btn-info">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
